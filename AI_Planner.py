...
configure(api_key="AIzaSyDR-Cl5gVjXNcBVpgb6ODPEYD-xEGh7VrY")
...
def generate_itinerary(city: str, interests: List[str], days: int) -> str:
    ...
    try:
        ...
        return response.text if response else "⚠ Could not generate itinerary. Please try again."
...
def create_ui():
    def get_itinerary():
        ...
        for line in itinerary.split("\n"):
            ...
            elif "🌦 Weather Conditions:" in line or "🚗 Best Mode of Transport:" in line:
                add_colored_text(result_text, f"\n{line}\n", "section_title")
            else:
